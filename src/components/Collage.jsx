  ...
  return (
    <div className="collage">
      <div className="collage-item special-offers">
        <img className="background-img" src={import.meta.env.VITE_IMG_URL + "collagebig.jpg"} alt="" />
      ...
      <div className="collage-item small-form-designs">
        <img className="background-img" src={import.meta.env.VITE_IMG_URL + "collage2.jpg"} alt="" />
<div className="overlay">
...
<div className="collage-item only-corsair">
        <img className="background-img" src={import.meta.env.VITE_IMG_URL + "collage3.jpg"} alt="" />
        <div className="overlay">
